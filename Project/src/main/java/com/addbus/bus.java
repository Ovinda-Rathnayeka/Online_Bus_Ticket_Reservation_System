...
public class bus {
    ...
    private String departureTime; // Consider using java.time.LocalTime for better time management
    private String departureDate; // Consider using java.time.LocalDate for better date management
    ...
    // Method to return the image URL (assuming you have an ImageServlet)
    public String getImageUrl() {
        return "/ImageServlet?id=" + busId; // URL to fetch the image
    }
}
